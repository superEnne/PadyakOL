...
public class SignupActivity extends AppCompatActivity {
    ...
    private FrameLayout btnGoogle, btnFacebook; // Changed to FrameLayout as per new XML
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(R.string.default_web_client_id)) // Automatically generated by google-services.json
                .requestEmail()
                .build();
        ...
        tvLoginLink.setOnClickListener(v -> {
            // Uncomment when LoginActivity exists
